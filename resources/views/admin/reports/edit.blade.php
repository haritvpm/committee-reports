    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reports.update", [$report->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_number') ? 'is-invalid' : '' }}" type="number" name="file_number" id="file_number" value="{{ old('file_number', $report->file_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('seat') ? 'is-invalid' : '' }}" name="seat_id" id="seat_id" required>
                    @foreach($seats as $id => $entry)
                        <option value="{{ $id }}" {{ (old('seat_id') ? old('seat_id') : $report->seat->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('seat'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('file_year') ? 'is-invalid' : '' }}" type="text" name="file_year" id="file_year" value="{{ old('file_year', $report->file_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from') ? 'is-invalid' : '' }}" type="text" name="from" id="from" value="{{ old('from', $report->from) }}" required>
                @if($errors->has('from'))
                    <div class="invalid-feedback">
                        {{ $errors->first('from') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from_eng') ? 'is-invalid' : '' }}" type="text" name="from_eng" id="from_eng" value="{{ old('from_eng', $report->from_eng) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dept') ? 'is-invalid' : '' }}" name="dept_id" id="dept_id">
                    @foreach($depts as $id => $entry)
                        <option value="{{ $id }}" {{ (old('dept_id') ? old('dept_id') : $report->dept->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('dept'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('received_date') ? 'is-invalid' : '' }}" type="text" name="received_date" id="received_date" value="{{ old('received_date', $report->received_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('submitted_date') ? 'is-invalid' : '' }}" type="text" name="submitted_date" id="submitted_date" value="{{ old('submitted_date', $report->submitted_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject') ? 'is-invalid' : '' }}" type="text" name="subject" id="subject" value="{{ old('subject', $report->subject) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subject_eng') ? 'is-invalid' : '' }}" type="text" name="subject_eng" id="subject_eng" value="{{ old('subject_eng', $report->subject_eng) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('district') ? 'is-invalid' : '' }}" name="district_id" id="district_id">
                    @foreach($districts as $id => $entry)
                        <option value="{{ $id }}" {{ (old('district_id') ? old('district_id') : $report->district->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
